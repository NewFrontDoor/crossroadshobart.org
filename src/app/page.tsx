        ...
        <div className="max-w-2xl m-auto flex flex-col pt-16 gap-16">
            <div className="p-2 font-display text-6xl font-bold text-center">
                <h1>
                    ...
                    <span className="text-emerald-500">Jesus</span>
                </h1>
            </div>
            ...
            <p>
                You’re welcome at Crossroads regardless of where you’re from or what you believe.{' '}
                <br />
                We meet Sundays at 4pm. <strong>25 Tasma St, North Hobart</strong> There’s singing,
                praying, a talk from the Bible, and a full kids program.{' '}
            </p>
            Crossroads is a group of individuals, singles, couples and families who believe that
            Jesus really, actually, lived, died and came back to life. As we live our normal
            Christian lives in Hobart, we trust that God will use us to add more people to his
            church.
